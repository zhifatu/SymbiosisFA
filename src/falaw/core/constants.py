...
from falaw.models.enums import ElementType as Element
...
class FALawConstants:
    ...
    SELF_RETENTION: Dict[Element, float] = field(default_factory=lambda: {
    ...
    POSSIBILITY_DIMENSIONS: List[str] = field(default_factory=lambda: [
        'stability',     # 稳定性
        'flexibility',   # 灵活性
        'diversity',     # 多样性
        'connectivity',  # 连接性
    ...
    ELEMENT_PROPERTIES: Dict[Element, List[float]] = field(default_factory=lambda: {
    ...
    EFFECT_PARAMS: Dict[str, float] = field(default_factory=lambda: {
    ...
    TENSION_THRESHOLDS: Dict[str, float] = field(default_factory=lambda: {
        'low': 0.2,
        'medium': 0.5,
        'high': 0.7,
        'critical': 0.9
